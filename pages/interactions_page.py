...
class ResizablePage(BasePage):
    ...
    def change_size_resizable_box(self):
        self.action_drag_and_drop_by_offset(self.element_is_present(self.locators.RESIZABLE_BOX_HANDLE), 50, 70)
        max_size = self.get_px_from_width_height(self.get_max_min_size(self.locators.RESIZABLE_BOX))
        self.action_drag_and_drop_by_offset(self.element_is_present(self.locators.RESIZABLE_BOX_HANDLE), -150, -150)
    ...
    def change_size_resizable(self):
        ...
        self.action_drag_and_drop_by_offset(self.element_is_present(self.locators.RESIZABLE_HANDLE),
                                            random.randint(-100, -1), random.randint(-100, -1))
...
class DroppablePage(BasePage):
    ...
    def drop_not_will_revert_draggable(self):
        self.element_is_visible(self.locators.REVERT_TAB).click()
...
class DragabblePage(BasePage):
    ...
    def axis_restricted_x(self):
        ...
        left_x_before = self.get_top_position(position_x[0])
        left_x_after = self.get_top_position(position_x[1])
    ...
    def axis_restricted_y(self):
        ...
        left_y_before = self.get_top_position(position_y[0])
        left_y_after = self.get_top_position(position_y[1])
