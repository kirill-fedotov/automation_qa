...
from locators.elements_page_locators import TextBoxPageLocators, CheckBoxPageLocators, RadioButtonPageLocators, \
    WebTablePageLocators, ButtonsPageLocators, LinksPageLocators, UploadAndDownloadFilePageLocators, \
    DynamicPropertiesLocators, DynamicPropertiesLocators
...
class UploadAndDownloadFilePage(BasePage):
    locators = UploadAndDownloadFilePageLocators()
    ...
    def download_file(self):
        ...
        patch_name_file = rf'C:\Users\XXX\PycharmProjects\automation_qa\filetest{random.randint(0, 999)}.jpg'
        with open(patch_name_file, 'wb+') as f:
            offset = link_b.find(b'\xff\xd8')
            f.write(link_b[offset:])
            check_file = os.path.exists(patch_name_file)
            f.close()
        os.remove(patch_name_file)
        return check_file
